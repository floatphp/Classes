...
/**
 * Advanced HTTP GET manipulation with enhanced security.
 */
final class Get
{
	/**
	...
	/**
	 * Get _GET value with enhanced validation and optional sanitization.
	 *
	 * @access public
	 * @param string|null $key The key to retrieve from $_GET
	 * @param bool $sanitize Whether to sanitize the output for XSS protection
	 * @return mixed Returns the sanitized value, null if not found, or entire $_GET array if key is null
	...
	/**
	 * Set _GET value with validation.
	 *
	 * @access public
	 * @param string $key The key to set in $_GET
	...
	/**
	 * Check _GET value with enhanced validation.
	 *
	 * @access public
	 * @param string|null $key The key to check in $_GET
	...
	/**
	 * Unset _GET value with validation.
	 *
	 * @access public
	 * @param string|null $key The key to unset from $_GET, or null to clear all
	 * @return void
	 * @throws InvalidArgumentException When key is invalid
	 */
